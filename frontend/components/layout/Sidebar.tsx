  ...
  return (
    ...
    >
        ...
        <div className={cn("flex items-center gap-3 w-full", collapsed && "justify-center")}>
          ...
          {!collapsed && (
            <motion.span 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-lg font-display font-semibold tracking-tight truncate"
            >
              OKM
            </motion.span>
          )}
      ...
      <div className="p-4 border-t border-border shrink-0 flex flex-col gap-2">
        {/* Quick Actions Row */}
        <div className={cn("flex items-center gap-1 mb-1", collapsed ? "flex-col" : "justify-between px-1")}>
          {/* Search */}
